...
export default class CardItem extends Component {
  ...
  setDid() {
    this.props.handleDid(this.props.card_id);
  }
  editCard() {
    message.config({
      top: 40
    ...
    return (
      <span className="component_card_item">
        <Card
          ...
          actions={[<Icon type="edit" onClick={this.editCard} />, <Icon type={this.state.liked ? 'heart' : 'heart-o'} onClick={this.setLike} />, <Icon type="delete" onClick={this.setDel} />, <Icon type="lock" onClick={this.setDid} />, <Icon type="desktop" onClick={this.showCard} />]}
        >
          <Meta
